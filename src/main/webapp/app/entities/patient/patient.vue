      ...
      <table class="table table-striped" aria-describedby="patients">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('ecom02App.patient.idPatient')"></span></th>
            ...
            <th scope="row"><span v-text="t$('ecom02App.patient.chambre')"></span></th>
            <th scope="row"><span v-text="t$('ecom02App.patient.poids')"></span></th>
            <th scope="row"><span v-text="t$('ecom02App.patient.dateArrivee')"></span></th>
            <th scope="row"><span v-text="t$('ecom02App.patient.idMedecin')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
