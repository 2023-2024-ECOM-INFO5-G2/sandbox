<template>
  <div>
    <h2 id="page-heading" data-cy="MedecinHeading">
      <span v-text="t$('ecom02App.medecin.home.title')" id="medecin-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('ecom02App.medecin.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'MedecinCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('ecom02App.medecin.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && medecins && medecins.length === 0">
      <span v-text="t$('ecom02App.medecin.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="medecins">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('ecom02App.medecin.idMedecin')"></span></th>
            <th scope="row"><span v-text="t$('ecom02App.medecin.firstName')"></span></th>
            <th scope="row"><span v-text="t$('ecom02App.medecin.lastName')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="ecom02App.medecin.delete.question" data-cy="medecinDeleteDialogHeading" v-text="t$('entity.delete.title')"></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-medecin-heading" v-text="t$('ecom02App.medecin.delete.question', { id: removeId })"></p>
      </div>
