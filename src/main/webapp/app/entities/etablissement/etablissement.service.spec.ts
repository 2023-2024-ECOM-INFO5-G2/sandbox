...
import { Etablissement } from '@/shared/model/etablissement.model';
...
describe('Service Tests', () => {
  describe('Etablissement Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Etablissement', async () => {
      ...
      it('should not update a Etablissement', async () => {
      ...
      it('should not partial update a Etablissement', async () => {
      ...
      it('should not return a list of Etablissement', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Etablissement', async () => {
