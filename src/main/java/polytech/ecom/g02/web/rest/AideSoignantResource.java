...
/**
 * REST controller for managing {@link polytech.ecom.g02.domain.AideSoignant}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AideSoignantResource {
     ...
     */
    @PostMapping("/aide-soignants")
    public ResponseEntity<AideSoignant> createAideSoignant(@Valid @RequestBody AideSoignant aideSoignant) throws URISyntaxException {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/aide-soignants/{id}")
    public ResponseEntity<AideSoignant> updateAideSoignant(
        @PathVariable(value = "id", required = false) final Long id,
        @Valid @RequestBody AideSoignant aideSoignant
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/aide-soignants/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<AideSoignant> partialUpdateAideSoignant(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody AideSoignant aideSoignant
    ) throws URISyntaxException {
        ...
        Optional<AideSoignant> result = aideSoignantRepository
            .findById(aideSoignant.getId())
            .map(existingAideSoignant -> {
                if (aideSoignant.getIdSoignant() != null) {
                    existingAideSoignant.setIdSoignant(aideSoignant.getIdSoignant());
                }
                if (aideSoignant.getPrenom() != null) {
                    existingAideSoignant.setPrenom(aideSoignant.getPrenom());
                }
                if (aideSoignant.getNom() != null) {
                    existingAideSoignant.setNom(aideSoignant.getNom());
                }

                return existingAideSoignant;
            })
            .map(aideSoignantRepository::save);
     ...
     */
    @GetMapping("/aide-soignants")
    public List<AideSoignant> getAllAideSoignants(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
     ...
     */
    @DeleteMapping("/aide-soignants/{id}")
