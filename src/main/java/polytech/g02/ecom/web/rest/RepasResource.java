...
/**
 * REST controller for managing {@link polytech.g02.ecom.domain.Repas}.
 */
@RestController
...
public class RepasResource {
     ...
     */
    @GetMapping("")
    public List<Repas> getAllRepas(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
