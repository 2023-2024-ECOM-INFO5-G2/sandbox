...
class PatientResourceIT {
    ...
    private static final Integer DEFAULT_CHAMBRE = 1;
    private static final Integer UPDATED_CHAMBRE = 2;
    ...
    void createPatient() throws Exception {
        ...
        assertThat(testPatient.getIdPatient()).isEqualTo(DEFAULT_ID_PATIENT);
        ...
        assertThat(testPatient.getChambre()).isEqualTo(DEFAULT_CHAMBRE);
    ...
    @Test
    @Transactional
    void checkIdPatientIsRequired() throws Exception {
    ...
    void putExistingPatient() throws Exception {
        ...
        Patient testPatient = patientList.get(patientList.size() - 1);
        assertThat(testPatient.getIdPatient()).isEqualTo(UPDATED_ID_PATIENT);
        ...
        assertThat(testPatient.getChambre()).isEqualTo(UPDATED_CHAMBRE);
