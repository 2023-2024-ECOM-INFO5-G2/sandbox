...
class RepasResourceIT {
    ...
    private static final Integer DEFAULT_ID_REPAS = 1;
    private static final Integer UPDATED_ID_REPAS = 2;
    ...
    void createRepas() throws Exception {
        ...
        assertThat(testRepas.getIdRepas()).isEqualTo(DEFAULT_ID_REPAS);
    ...
    @Test
    @Transactional
    void checkIdRepasIsRequired() throws Exception {
        int databaseSizeBeforeTest = repasRepository.findAll().size();
        // set the field null
        repas.setIdRepas(null);
    ...
    void getAllRepas() throws Exception {
        ...
        restRepasMockMvc
            ...
            .andExpect(jsonPath("$.[*].idRepas").value(hasItem(DEFAULT_ID_REPAS)))
    ...
    void getRepas() throws Exception {
        ...
        restRepasMockMvc
            ...
            .andExpect(jsonPath("$.idRepas").value(DEFAULT_ID_REPAS))
    ...
    void putExistingRepas() throws Exception {
        ...
        updatedRepas.idRepas(UPDATED_ID_REPAS).nom(UPDATED_NOM).description(UPDATED_DESCRIPTION).apportCalorique(UPDATED_APPORT_CALORIQUE);
        ...
        Repas testRepas = repasList.get(repasList.size() - 1);
        assertThat(testRepas.getIdRepas()).isEqualTo(UPDATED_ID_REPAS);
    ...
    void partialUpdateRepasWithPatch() throws Exception {
        ...
        partialUpdatedRepas.idRepas(UPDATED_ID_REPAS).nom(UPDATED_NOM);
