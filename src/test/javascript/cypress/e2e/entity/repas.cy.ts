...
describe('Repas e2e test', () => {
  ...
  const repasSample = {
    idRepas: 23705,
    nom: 'de façon à sympathique',
    description: 'séculaire de sorte que de sorte que',
    apportCalorique: 799,
  };
  ...
  describe('new Repas page', () => {
    ...
    it('should create an instance of Repas', () => {
      cy.get(`[data-cy="idRepas"]`).type('30115');
      cy.get(`[data-cy="idRepas"]`).should('have.value', '30115');

      cy.get(`[data-cy="nom"]`).type('émerger');
      cy.get(`[data-cy="nom"]`).should('have.value', 'émerger');

      cy.get(`[data-cy="description"]`).type('au-dessus de');
      cy.get(`[data-cy="description"]`).should('have.value', 'au-dessus de');

      cy.get(`[data-cy="apportCalorique"]`).type('17784');
      cy.get(`[data-cy="apportCalorique"]`).should('have.value', '17784');
