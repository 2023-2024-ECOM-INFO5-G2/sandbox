...
describe('Infirmiere e2e test', () => {
  ...
  const infirmiereSample = { idInfirmiere: 26684, prenom: 'plic cadre hypocrite', nom: 'triangulaire en guise de séculaire' };
  ...
  describe('new Infirmiere page', () => {
    ...
    it('should create an instance of Infirmiere', () => {
      cy.get(`[data-cy="idInfirmiere"]`).type('27970');
      cy.get(`[data-cy="idInfirmiere"]`).should('have.value', '27970');

      cy.get(`[data-cy="prenom"]`).type('écraser marquer');
      cy.get(`[data-cy="prenom"]`).should('have.value', 'écraser marquer');

      cy.get(`[data-cy="nom"]`).type('avant que');
      cy.get(`[data-cy="nom"]`).should('have.value', 'avant que');
