...
describe('Medecin e2e test', () => {
  ...
  const medecinSample = { idMedecin: 27367, firstName: 'Amante', lastName: 'Robert' };
  ...
  describe('new Medecin page', () => {
    ...
    it('should create an instance of Medecin', () => {
      cy.get(`[data-cy="idMedecin"]`).type('2237');
      cy.get(`[data-cy="idMedecin"]`).should('have.value', '2237');

      cy.get(`[data-cy="firstName"]`).type('Maxellende');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Maxellende');

      cy.get(`[data-cy="lastName"]`).type('Martinez');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Martinez');
