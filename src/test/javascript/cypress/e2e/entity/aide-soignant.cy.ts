...
describe('AideSoignant e2e test', () => {
  ...
  const aideSoignantSample = { idSoignant: 27285, prenom: 'sauvage', nom: 'alors que' };
  ...
  describe('new AideSoignant page', () => {
    ...
    it('should create an instance of AideSoignant', () => {
      cy.get(`[data-cy="idSoignant"]`).type('31486');
      cy.get(`[data-cy="idSoignant"]`).should('have.value', '31486');

      cy.get(`[data-cy="prenom"]`).type('derechef');
      cy.get(`[data-cy="prenom"]`).should('have.value', 'derechef');

      cy.get(`[data-cy="nom"]`).type('après-demain bon aussitôt');
      cy.get(`[data-cy="nom"]`).should('have.value', 'après-demain bon aussitôt');
